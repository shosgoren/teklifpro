    ...
    const updatedProposal = await prisma.$transaction(async (tx) => {
      ...
      const updated = await tx.proposal.update({
        ...
        data: {
          ...
          deliveryDate: validatedData.deliveryDate !== undefined ? (validatedData.deliveryDate ? new Date(validatedData.deliveryDate) : null) : undefined,
          installationDate: validatedData.installationDate !== undefined ? (validatedData.installationDate ? new Date(validatedData.installationDate) : null) : undefined,
          deliveryCompleted: validatedData.deliveryCompleted ?? undefined,
          installationCompleted: validatedData.installationCompleted ?? undefined,
          subtotal,
          discountAmount,
          vatTotal,
          grandTotal,
