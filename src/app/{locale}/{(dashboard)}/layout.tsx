...
const navigation: NavItem[] = [
  ...
  { name: 'Teklifler', href: '/dashboard/teklifler', icon: <FileText className="w-5 h-5" /> },
  { name: 'Müşteriler', href: '/dashboard/musteriler', icon: <Users className="w-5 h-5" /> },
  { name: 'Ürünler', href: '/dashboard/urunler', icon: <Package className="w-5 h-5" /> },
  { name: 'Analitik', href: '/dashboard/analitik', icon: <BarChart3 className="w-5 h-5" /> },
  { name: 'Ayarlar', href: '/dashboard/ayarlar', icon: <Settings className="w-5 h-5" /> },
]
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-slate-700/50">
            <div className="bg-slate-800/30 rounded-lg p-4 backdrop-blur-sm border border-slate-700/30">
              ...
              <button className="w-full flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-slate-300 bg-slate-900/50 hover:bg-slate-900 rounded-md transition-colors duration-200 border border-slate-700/30 hover:border-slate-600/50">
